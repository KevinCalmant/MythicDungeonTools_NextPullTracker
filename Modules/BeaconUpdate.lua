...
function Beacon:Update()
  ...
  local centroidX, centroidY = BeaconMinimap.calculatePullCentroid(pull, sublevel, enemies)
  if centroidX and centroidY then
    BeaconMinimap.centerMinimapOnPull(frame, centroidX, centroidY)
  end
